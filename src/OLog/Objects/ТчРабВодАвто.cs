    ...
    public class ТчРабВодАвто : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТчРабВодАвтоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТчРабВодАвтоE", typeof(IIS.OLog.ТчРабВодАвто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТчРабВодАвтоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТчРабВодАвтоL", typeof(IIS.OLog.ТчРабВодАвто));
                }
            }
        }
    }
