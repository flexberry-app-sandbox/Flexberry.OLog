    ...
    public class РукОтдЛог : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РукОтдЛогE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РукОтдЛогE", typeof(IIS.OLog.РукОтдЛог));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РукОтдЛогL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РукОтдЛогL", typeof(IIS.OLog.РукОтдЛог));
                }
            }
        }
    }
