...
namespace IIS.OLog
{
    ...
    public class Персонал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OLog.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.OLog.Должности Должности
        {
            get
            {
                ...
                IIS.OLog.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПерсоналE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналE", typeof(IIS.OLog.Персонал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПерсоналL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналL", typeof(IIS.OLog.Персонал));
                }
            }
        }
    }
