...
namespace IIS.OLog
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OLog.РукОтдЛог fРукОтдЛог;
        
        private IIS.OLog.Организация fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.OLog.Организация Организация
        {
            get
            {
                ...
                IIS.OLog.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "РукОтдЛог"})]
        [NotNull()]
        public virtual IIS.OLog.РукОтдЛог РукОтдЛог
        {
            get
            {
                ...
                IIS.OLog.РукОтдЛог result = this.fРукОтдЛог;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.OLog.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.OLog.Договор));
                }
            }
        }
    }
