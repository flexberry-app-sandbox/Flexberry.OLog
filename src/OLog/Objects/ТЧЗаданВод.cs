...
namespace IIS.OLog
{
    ...
    public class ТЧЗаданВод : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OLog.Контрагент fКонтрагент;
        ...
        /// Т ч задан вод.
        /// </summary>
        // *** Start programmer edit section *** (ТЧЗаданВод.Контрагент CustomAttributes)

        // *** End programmer edit section *** (ТЧЗаданВод.Контрагент CustomAttributes)
        [PropertyStorage(new string[] {
                "Контрагент"})]
        [NotNull()]
        public virtual IIS.OLog.Контрагент Контрагент
        {
            get
            {
                // *** Start programmer edit section *** (ТЧЗаданВод.Контрагент Get start)

                // *** End programmer edit section *** (ТЧЗаданВод.Контрагент Get start)
                IIS.OLog.Контрагент result = this.fКонтрагент;
                // *** Start programmer edit section *** (ТЧЗаданВод.Контрагент Get end)

                // *** End programmer edit section *** (ТЧЗаданВод.Контрагент Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ТЧЗаданВод.Контрагент Set start)

                // *** End programmer edit section *** (ТЧЗаданВод.Контрагент Set start)
                this.fКонтрагент = value;
                // *** Start programmer edit section *** (ТЧЗаданВод.Контрагент Set end)

                // *** End programmer edit section *** (ТЧЗаданВод.Контрагент Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаданВодE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаданВодE", typeof(IIS.OLog.ТЧЗаданВод));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТЧЗаданВодL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаданВодL", typeof(IIS.OLog.ТЧЗаданВод));
                }
            }
        }
    }
